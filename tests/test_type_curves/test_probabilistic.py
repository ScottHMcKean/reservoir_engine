...
class TestGenerateTypeCurve:
    ...
    def test_generates_percentiles(self, sample_production_monthly_df):
        # First align the data
        aligned = align_production(sample_production_monthly_df)
    ...
    def test_p10_less_than_p90(self, sample_production_monthly_df):
        aligned = align_production(sample_production_monthly_df)
...
class TestSampleTypeCurve:
    ...
    def test_generates_samples(self, sample_production_monthly_df):
        aligned = align_production(sample_production_monthly_df)
